...
describe('todosList', function() {
  ...
  describe('component', function() {
    it('should be showing incomplete tasks count', function() {
      assert.include(element[0].querySelector('h5.incomplete').innerHTML, '0');
    });

    it('should be showing complete tasks count', function() {
      assert.include(element[0].querySelector('h5.complete').innerHTML, '0');
    });
  });
